    ...
    public class RolePageController : BaseController
    {
                ...
                else
                {
                    ...
                    if (dataItem != null)
                    {
                        ...
                        if (controlIDs.Count == 0)
                        {
                            ...
                            this.MASTERLogs.Write(this.Repository, EAction.Delete, JsonConvert.SerializeObject(dataItem));
                        }
                        else
                        {
                            dataItem.UpdateAt = DateTime.Now;
        ...
        public IHttpActionResult GetRolePage(RoleReqVM dataRequest)
        {
            try
            {
                ...
                {
                    errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(MASTERResources.ID.MsgErrorRequire),
                        MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_RoleID)), ". ");
                }
                //RoleID
                if (string.IsNullOrEmpty(dataRequest.PageID) || string.IsNullOrWhiteSpace(dataRequest.PageID))
                {
                    errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(MASTERResources.ID.MsgErrorRequire),
                        MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_PageID)), ". ");
        ...
        //    {
        //        errMsg = string.Concat(errMsg, string.Format(MASTERResources.Instance.Get(
        //                MASTERResources.ID.MsgErrorRequire), MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_RoleID)), ". ");
        //    }
        //    else
        //    {
        ...
        //        {
        //            errMsg = string.Concat(errMsg, string.Format(MASTERResources.Instance.Get(
        //                MASTERResources.ID.MsgErrorMaximumLength), MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_RoleID), 50), ". ");
        //        }
        //    }
        ...
        //    {
        //        errMsg = string.Concat(errMsg, string.Format(MASTERResources.Instance.Get(
        //                MASTERResources.ID.MsgErrorRequire), MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_PageID)), ". ");
        //    }
        //    else
        //    {
        ...
        //        {
        //            errMsg = string.Concat(errMsg, string.Format(MASTERResources.Instance.Get(
        //                MASTERResources.ID.MsgErrorMaximumLength), MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_PageID), 50), ". ");
        //        }
        //    }
        //}
        ...
        //        {
        //            errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(MASTERResources.ID.MsgErrorRequire),
        //                MASTERResources.Instance.Get(MASTERResources.ID.Label_RolePage_ControlStr)), ". ");
        //        }
        ...
        //                    this.MASTERLogs.Write(this.Repository, EAction.Insert, JsonConvert.SerializeObject(controlNew));
        //                }
        ...
        //            this.MASTERLogs.Write(this.Repository, EAction.Update, JsonConvert.SerializeObject(page));
        //        }
        //        else
        //        {
        ...
        //            this.MASTERLogs.Write(this.Repository, EAction.Insert, JsonConvert.SerializeObject(pageNew));
        //        }
