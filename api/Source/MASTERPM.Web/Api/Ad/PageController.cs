    ...
    public class PageController : BaseController
    {
        ...
        public IHttpActionResult Put(string id, [FromBody] AD_PAGE dataRequest)
        {
            try
            {
                ...
                dataItem.UpdateBy = MASTERHelper.GetUserName();
                ...
                if (fileUrls != dataRequest.FileUrls)
                {
                    if (dataItem.FileUrls != "" && dataItem.FileUrls != "\"\"")
                    {
                        ...
                        string userCurrent = MASTERHelper.GetUserName();
                        try
                        {
                ...
                {
                    Status = (short)EStatus.Ok,
                    Msg = string.Format(MASTERResources.Instance.Get(MASTERResources.ID.MsgUpdateDataSuccess),
                        MASTERResources.Instance.Get(MASTERResources.ID.Label_obj_page)),
                    Data = dataItem
                });
            }
            catch (Exception e)
        ...
        public IHttpActionResult Post([FromBody] AD_PAGE dataRequest)
        {
            try
            {
                ...
                {
                    Status = (short)EStatus.Ok,
                    Msg = string.Format(MASTERResources.Instance.Get(MASTERResources.ID.MsgCreateDataSuccess),
                        MASTERResources.Instance.Get(MASTERResources.ID.Label_obj_page)),
                    Data = dataItem
                });
            }
        ...
        public IHttpActionResult GetMenu(string roleID)
        {
            try
            {
                ...
                if (result.Count == 0)
                {
                    ...
                    {
                        Status = (short)EStatus.Fail,
                        Msg = MASTERResources.Instance.Get(MASTERResources.ID.MsgAccessDenined)
                    });
                }
        ...
        private void GetValidate(AD_PAGE item, ref string errorMsg)
        {
            ...
            {
                errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(
                        MASTERResources.ID.MsgErrorRequire), MASTERResources.Instance.Get(MASTERResources.ID.Label_page_ID)), ". ");
            }
            else
            {
                ...
                {
                    errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(
                        MASTERResources.ID.MsgErrorMaximumLength), MASTERResources.Instance.Get(MASTERResources.ID.Label_page_ID), 150), ". ");
                }
                if (CustomValidation.hasSpace(item.ID))
                {
                    errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(
                        MASTERResources.ID.MsgErrorHasSpace), MASTERResources.Instance.Get(MASTERResources.ID.Label_page_ID)), ". ");
                }
            }
            ...
            {
                errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(
                        MASTERResources.ID.MsgErrorRequire), MASTERResources.Instance.Get(MASTERResources.ID.Label_page_Nm)), ". ");
            }
            else
            {
                ...
                {
                    errorMsg = string.Concat(errorMsg, string.Format(MASTERResources.Instance.Get(
                        MASTERResources.ID.MsgErrorMaximumLength), MASTERResources.Instance.Get(MASTERResources.ID.Label_page_Nm), 150), ". ");
                }
            }
        }
