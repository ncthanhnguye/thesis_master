...
using MASTERPM.Web.Api.Ad;
using MASTERPM.Web.Api.Base;

namespace MASTERPM.Web.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            {
                context.SetError("invalid_grant", MASTERResources.Instance.Get(userInformation.Msg));
                return;
            }
        ...
        public override Task TokenEndpointResponse(OAuthTokenEndpointResponseContext context)
        {
            ...
            baseController.MASTERLogs.Write(baseController.Repository, EAction.Insert, JsonConvert.SerializeObject(dataItem));
